...
namespace SIERRHH.Controllers
{
    public class SectorController : Controller
    {
        ...
        public SectorController(AppBdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdSector,NombreSector,Estado")] Sector sector)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdSector,NombreSector,Estado")] Sector sector)
        {
